...
> = {
  addNewReservation?: Resolver<
    ResolversTypes['Reservation'],
    ParentType,
    ContextType,
    RequireFields<MutationAddNewReservationArgs, 'input'>
  >
  addNewRestaurant?: Resolver<
    ResolversTypes['Restaurant'],
    ParentType,
    ContextType,
    RequireFields<MutationAddNewRestaurantArgs, 'input'>
  >
  addTableToRestaurant?: Resolver<
    ResolversTypes['Table'],
    ParentType,
    ContextType,
    RequireFields<MutationAddTableToRestaurantArgs, 'input' | 'restaurantId'>
  >
  deleteReservation?: Resolver<
    Maybe<ResolversTypes['String']>,
    ParentType,
    ContextType,
    RequireFields<MutationDeleteReservationArgs, 'id'>
  >
  deleteRestaurant?: Resolver<
    Maybe<ResolversTypes['String']>,
    ParentType,
    ContextType,
    RequireFields<MutationDeleteRestaurantArgs, 'id'>
  >
  removeTableFromRestaurant?: Resolver<
    Maybe<ResolversTypes['String']>,
    ParentType,
    ContextType,
    RequireFields<MutationRemoveTableFromRestaurantArgs, 'id'>
  >
  updateReservation?: Resolver<
    ResolversTypes['Reservation'],
    ParentType,
    ContextType,
    RequireFields<MutationUpdateReservationArgs, 'id' | 'input'>
  >
  updateRestaurant?: Resolver<
    ResolversTypes['Restaurant'],
    ParentType,
    ContextType,
    RequireFields<MutationUpdateRestaurantArgs, 'id' | 'input'>
  >
}
...
> = {
  getReservationById?: Resolver<
    Maybe<ResolversTypes['Reservation']>,
    ParentType,
    ContextType,
    RequireFields<QueryGetReservationByIdArgs, 'id'>
  >
  getRestaurantById?: Resolver<
    Maybe<ResolversTypes['Restaurant']>,
    ParentType,
    ContextType,
    RequireFields<QueryGetRestaurantByIdArgs, 'id'>
  >
  getTables?: Resolver<
    Maybe<Array<Maybe<ResolversTypes['Table']>>>,
    ParentType,
    ContextType,
    Partial<QueryGetTablesArgs>
  >
  reservations?: Resolver<
    Maybe<Array<Maybe<ResolversTypes['Reservation']>>>,
    ParentType,
    ContextType
  >
  restaurants?: Resolver<
    ...
    ContextType
  >
  searchRestaurants?: Resolver<
    Maybe<Array<Maybe<ResolversTypes['Restaurant']>>>,
    ParentType,
    ContextType,
    Partial<QuerySearchRestaurantsArgs>
  >
  tables?: Resolver<
    Maybe<Array<Maybe<ResolversTypes['Table']>>>,
    ParentType,
